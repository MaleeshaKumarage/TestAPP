...
const STYLE_OPTIONS = {
  ...
  // Avatar
  //avatarSize: 40,
  botAvatarBackgroundColor: 'transparent', // defaults to accent color
  botAvatarImage: 'https://res.cloudinary.com/vevro/image/upload/v1570954334/nluksdu1lr4t5f9xfubt.png',
  //botAvatarInitials: '',
  userAvatarBackgroundColor: 'transparent', // defaults to accent color
  userAvatarImage: 'https://res.cloudinary.com/vevro/image/upload/v1570953989/r3jn2uymboqtq2dzj2qu.png',
  //userAvatarInitials: '',
  ...
  sendBoxBackground: 'rbga(255,255,255,0.3)',
